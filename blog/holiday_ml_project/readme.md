...
EDIT: I decided to ask ChatGPT to generate structs and mappers based on the domain model here and it did a great job. So I'll probably just use ChatGPT to handle most of my boilerplate and mappers going forward. Hurray!
